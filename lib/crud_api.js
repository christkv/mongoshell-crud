...
DBCollection.prototype.bulkWrite = function(operations, options) {
    ...
    var writeConcern = createWriteConcern(this, opts);
    ...
    operations.forEach(function(op) {
        if(op.insertOne) {
            ...
            if(op.insertOne.document._id == null) {
